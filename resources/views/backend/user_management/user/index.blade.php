...
@section('content')
    ...
    @can('user.create')
        <div class="modal fade drawer-modal" id="Modal_Tambah_Data" tabindex="-1" aria-hidden="true">
    ...
    @endcan
    @can('user.ban')
        <div class="modal fade drawer-modal" id="ModalBanUser" tabindex="-1" aria-labelledby="ModalBanUserLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
